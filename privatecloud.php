...
<body>
    ...
    <main id="content" role="main" class="overflow-hidden">
        <!-- Hero Section -->
        <div class="position-relative bg-red overflow-hidden">
                    ...
                    <div class="mb-7">
                        <div class="min-w-10rem mr-2 mb-2 h-30">
                            <figure class="avatar mx-auto rounded-circle bg-soft-light" style="width: 4rem;height: 4rem; padding: .9rem;">
                                <i class="fas fa-lock text-white" style="font-size: 2rem;"></i>
                            </figure>
        ...
        <g opacity=".5">
          <linearGradient id="doubleEllipseTopLeftID1" gradientUnits="userSpaceOnUse" x1="2073.5078" y1="1.7251" x2="2273.4375" y2="1135.5818" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="0.4976" style="stop-color:#F3533A"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#851d0d1c"/>
          </linearGradient>
          ...
          <linearGradient id="doubleEllipseTopLeftID2" gradientUnits="userSpaceOnUse" x1="1717.1648" y1="3.779560e-05" x2="1717.1648" y2="644.0417" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="1.577052e-06" style="stop-color:#F3533A"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#851d0d1c"/>
          </linearGradient>
      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Private cloud hosting Plan and Pricing </h2>
                    <p> Select the best Private cloud hosting plan</p>
                </div>
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose Our Managed Private Cloud Hosting service?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our team of cloud hosting experts will completely manage your private cloud hosting infrastructure, while you can focus on growing your business.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our team of cloud experts is available 24/7 to assist you with any hosting-related issues and concerns.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We know the value of your business data. Hence, to ensures its security and safety we perform regular data backups. </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our cloud environment is highly scalable. You can easily scale your server resources to meet the ever-changing workload demands.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our Private cloud servers are fully optimized to offer unmatched performance with the highest level of privacy and flexibility.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Enjoy an uninterrupted, fast, and secure hosting experience. We guarantee to offer a 99.9% uptime SLA.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="position-relative bg-primary overflow-hidden ">
            <div class="container space-top-2 space-top-lg-3 position-relative z-index-2 ">
                ...
                <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9 ">
                    <h2 class="text-white ">Easily Migrate to our Private Cloud Environment</h2>
                    <p class="text-white-70 ">Do you wish to migrate to a private cloud environment that is highly customizable, scalable, and secure? Our cloud experts can ensure a smooth and easy transition from your existing hosting provider to our environment.
                    </p>
