...
<body>
    ...
    <main id="content" role="main" class="overflow-hidden">
        <!-- Hero Section -->
        <div class="position-relative bg-success overflow-hidden">
                    ...
                    <div class="mb-7">
                        <div class="min-w-10rem mr-2 mb-2 h-30">
                            <figure class="avatar mx-auto rounded-circle bg-soft-light" style="width: 4rem;height: 4rem; padding: .9rem;">
                                <i class="fas fa-broadcast-tower text-white" style="font-size: 2rem;"></i>
                            </figure>
        ...
        <g opacity=".3">
          <linearGradient id="doubleEllipseTopLeftID1" gradientUnits="userSpaceOnUse" x1="2073.5078" y1="1.7251" x2="2273.4375" y2="1135.5818" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="0.4976" style="stop-color:#2de0bd"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#1eac8f"/>
          </linearGradient>
          ...
          <linearGradient id="doubleEllipseTopLeftID2" gradientUnits="userSpaceOnUse" x1="1717.1648" y1="3.779560e-05" x2="1717.1648" y2="644.0417" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="1.577052e-06" style="stop-color:#2de0bd"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#1eac8f"/>
          </linearGradient>
      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Radio Stream Hosting Service Plan and Pricing</h2>
                    <p>Select the best Radio Stream hosting plan</p>
                </div>
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose Our Managed Radio Hosting Services?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>99.9% Network Uptime
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">With continuous monitoring and instant issue resolution, we guarantee to keep your radio station website up and running 24/7.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our radio hosting services come equipped with a cPanel control panel for effective management of your account.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Scalable </h4>
                            <p class="font-size-1 text-body mb-0 ">We provide radio hosting services that allows easy scaling of your server resources as per the current demands and requirements.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4> Low Latency</h4>
                            <p class="font-size-1 text-body mb-0 ">Choose our radio hosting service and get your audio stream delivered to your listener base without any delay.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Best Audio Quality </h4>
                            <p class="font-size-1 text-body mb-0 ">Offer your listeners an immersive experience by delivering a high-quality audio stream through a content delivery network.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our radio hosting services are backed by 24/7 support to assist you with any issues and concerns.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
