      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Moodle Hosting Plan and Pricing</h2>
                    <p> Select the best Moodle hosting Plan to get started
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose our Moodle LMS Hosting Service? </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our team of experts will completely manage and optimize your hosting servers to offer optimal performance.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">As your learners' list grows, so is your hosting plan. We let you easily scale your resources according to current demands.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our team of cloud experts are available round-the-clock to offer reliable support and assist you in solving any issue that arises. </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>99.9% Uptime </h4>
                            <p class="font-size-1 text-body mb-0 ">We follow some of the best security practices to ensure your platform is live and running without any interruptions.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our Moodle hosting servers are fully optimized to offer optimal performance and a personalized learning experience to your learners. </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We follow some of the best security practices and make sure to keep your data safe and secure from any attack or loss.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="position-relative bg-primary overflow-hidden ">
            <div class="container space-top-2 space-top-lg-3 position-relative z-index-2 ">
                ...
                <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9 ">
                    <h2 class="text-white ">Simple and Robust Moodle LMS </h2>
                    <p class="text-white-70 ">Choose our hosted Moodle LMS platform and streamline the delivery of your online e-learning content. With our simple and robust hosted LMS platform you can have all of your training materials in one place which is easily accessible
                        for your learners. Also, you need not have to worry about managing your IT or server requirements. Our experts will take care of your Moodle LMS, while you can concentrate entirely on developing quality training content.
                    </p>
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseOne" class="collapse" aria-labelledby="basicsHeadingOne" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Moodle is an open-source learning management system (LMS) designed to help educators create quality online learning content and effortlessly deliver it to their learners. With a host of features and customization options to
                                offer Moodle is one of the most popular LMS platforms.
                            </p>
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>We promise complete transparency in billing with no hidden charges.
                            </p>
