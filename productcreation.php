    ...
    <section class="space-top-1 space-bottom-2">
        ...
        <div class="container space-2">
            ...
            <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                <h2>Customize and Compare your Cloud Servers</h2>
            </div>
            <!-- End Title -->

            <div class="row mx-n2 mx-lg-n3 justify-content-center">


                <div class="col-sm-6 col-lg-4 px-2 px-lg-3 mb-3 mb-lg-0">
                    <!-- Card -->
                    <a class="card bg-primary text-left h-100 transition-3d-hover" href="./compareproduct.php">
                        <div class="card-body">
                            <div class="mb-5">
                                <h3 class="text-white">Compare Clouds</h3>
                                <p class="text-white">Start comparing your clouds from different providers with customized configurations.</p>
                            </div>
                            <img class="img-fluid w-100" src="./assets/svg/illustrations/snippets-frame.svg" alt="Image Description">
                        </div>
                        <div class="card-footer border-0 bg-transparent pt-0">
                            <span class="font-size-1 text-white font-weight-bold">Start Comparing <i class="fas fa-angle-right fa-sm ml-1"></i></span>
                        </div>
                    </a>
                    <!-- End Card -->
                </div>
                ...
                <div class="col-sm-6 col-lg-4 px-2 px-lg-3">
                    <!-- Card -->
                    <a class="card bg-dark text-left h-100 transition-3d-hover" href="./customizeproduct.php">
                        <div class="card-body">
                            <div class="mb-5">
                                <h3 class="text-white">Customize Cloud</h3>
                                <p class="text-white">Start creating your clouds from different providers with customized configurations.</p>
                            </div>
                            <img class="img-fluid w-100" src="./assets/svg/illustrations/drag-n-drop.svg" alt="Image Description">
                        </div>
                        <div class="card-footer border-0 bg-transparent pt-0">
                            <span class="font-size-1 text-white font-weight-bold">Start Customizing <i class="fas fa-angle-right fa-sm ml-1"></i></span>
                        </div>
                    </a>
                    <!-- End Card -->
                </div>
