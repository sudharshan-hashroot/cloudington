      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Cloud Backup Services hosting Plan and Pricing</h2>
                    <p>Select the best Cloud Backup Services hosting plan</p>
                </div>
      ...
      ">
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose Our Cloud Backup Service?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our encrypted cloud backup services ensure to keep your data protected and secure against any forms of loss or attacks.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Businesses can have all their valuable data backed up to our cloud storage system at an affordable budget.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Scalable</h4>
                            <p class="font-size-1 text-body mb-0 ">Need more data storage space? With just a few clicks, you can easily upgrade your storage capacity.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Data stored in our cloud can be accessed from anywhere at any time through devices that have access to the internet.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Effective File Versioning
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">Each backup file that you make is versioned effectively, thereby allowing you to easily restore specific versions of your data when required.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <span class="card-btn-toggle">
          ...
          <span class="card-btn-toggle-active">&minus;</span>
                    ...
                    <div id="syncingCollapseTwo" class="collapse" aria-labelledby="syncingHeadingTwo" data-parent="#syncingAccordion">
                        <div class="card-body px-0">
                            <p>Your data is completely safe and secure with us. With an advanced level of security protocols and regular monitoring, we guarantee to keep your data secure from any form of disaster or attack. You can also use encryption keys
