            ...
            <div class="w-lg-80 mx-lg-auto">
                <div class="card">
                    ...
                    <div class="card-header position-relative d-block bg-primary space-1 space-md-2 p-4 px-md-7 px-md-9">
                        ...
                        <p class="text-white-70">Last modified: June 11, 2021</p>
                ...
                <path fill="#fff" d="M0,0c0,0,934.4,93.4,1920,0v100.1H0L0,0z"/>
                    ...
                    <div class="card-body p-4 p-md-9">
                        ...
                        <div class="mb-7">
                            ...
                            <!-- Text -->
                            <ul>
                                <li>Account Registration : When you register for an Account, we may ask for your contact information, including items such as name, company name, address, email address, Zip Code and telephone number
                                </li>
                                <li>Payment Information : When you add your financial account information to your Account, that information is directed to our third-party payment processor. We also do not store your financial account information on our systems.
                                </li>
                                <li>Communications : If you contact us directly or through our chat window, we may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you
                                    may send us, and any other information you may choose to provide. We may also receive a confirmation when you open an email from us.</li>
                                <li>We may use session cookies to make it easier for you to navigate our site. The cookie itself does not contain Personal Information although it will enable us to relate your use of this site to information that you have
                                    specifically and knowingly provided. You can refuse cookies by turning them off in your browser. A session ID cookie expires when you close your browser. A persistent cookie remains on your hard drive for an extended
                                    period of time. You can remove persistent cookies by following the instructions provided in your internet browser.
                                </li>
                        ...
                        <div class="mb-7">
                            <!-- Title -->
                            <h5>Information We Collect When You Use Our Services
                            </h5>
                            <!-- Text -->
                            <ul>
                                <li>Your name, address, and contact details</li>
                                <li>Your payment details or bank details. We do not store card numbers. </li>
                                <li>Your login details, and usage statistics</li>
                                <li>Any sales, billing, and support communications you made.</li>
                            </ul>
                            <!-- End Text -->
                        </div>
                        <div class="mb-7">
                            <!-- Title -->
                            <h5>Information We Receive from Third Parties
                            </h5>
                            <!-- Text -->
                            <ul>
                                <li>Third-Party Partners. We may also receive publicly available information about you and combine it with data that we have about you.
                                </li>
                                <li>Your location, IP address, browser information, time you spend on our website, the number of visits you made and your referral websites or links.
                                </li>
                        ...
                        <div class="mb-7">
                            ...
                            <p>We use the information we collect in various ways. This includes:
                            </p>
                            <ul class="mb-3">
                                <li>Create and manage your hosting account with us.
                                </li>
                                <li>Understand, analyze and train our employees with respective client knowledge base, Develop new services, features, and customer case studies.
                                </li>
                                <li> To contact you about the services on our site in which you have expressed interest. Also, if we have trouble processing your order, we will use this information to contact you.
                                </li>
                                <li>
                                ...
                                <li> Notify you of any changes to our website or to our services that may affect you
                                </li>
                            </ul>
                            <div class="bg-soft-danger text-danger border-rounded p-2">
                                <p class="m-0">
                                    Note: This website is not intended to be used by children below the age of 13 years. We do not knowingly collect or use personal information relating to children.
                                </p>
                            </div>
                        </div>
                        <div class="mb-7">
                            ...
                            <ul class="mb-3">
                                <li> Vendors and Service Providers. We may share information with third-party tools or software with your consent for helping you provide our Services.
                                </li>
                                <li>For processing card payments
                                </li>
                                <li>Business Transfers. Information may be disclosed and otherwise transferred after your consent to any potential acquirer, successor, or assignee as part of any proposed merger, acquisition, debt financing, sale of assets,
                                    or similar transaction, or in the event of insolvency, bankruptcy, or receivership in which information is transferred to one or more third parties as one of our business assets.
                                </li>
                                <li>As Required By Law and Similar Disclosures. We may also share information to (i) satisfy any applicable law, regulation, legal process, or governmental request; (ii) enforce this Privacy Policy and our Terms of Service,
                                    including investigation of potential violations hereof; (iii) detect, prevent, or otherwise address fraud, security, or technical issues; (iv) respond to your requests; or (v) protect our rights, property or safety,
                                    our users and the public. This includes exchanging information with other companies and organizations for fraud protection and spam/malware prevention.
                                </li>
                            </ul>
                        </div>
                        <div class="mb-7">
                        ...
                        <div class="mb-7">
                            ...
                            <div class="bg-soft-warning text-warning border-rounded p-2">
                                <p class="m-0">Our project office is located in a 24/7 public access restricted space secured by the state police department. Our office infrastructure is 24/7/365 monitored with CCTV cameras and access to the working spaces are restricted
                        ...
                        <div class="mb-7">
                            ...
                            <p>We retain personal information we collect from you where we have an ongoing legitimate business need to do so (for example, to provide you with a service you have requested or to comply with applicable legal, tax, or accounting
                                requirements). When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize it or, if this is not possible (for example, because your personal information has
                        ...
                        <div class="mb-7">
                            ...
                            <ul>
                                ...
                                <li>You have the right to complain to a data protection authority about our collection and use of your personal information. For more information, please contact your local data protection authority.
                                </li>
                            </ul>
                        </div>
                        <div class="mb-7">
                            ...
                            <p>You can use some of the features of the Services without registering, thereby limiting the type of information that we collect.
                            </p>
                        </div>
                        <div class="mb-7">
                        ...
                        <div class="mb-7">
                            <h3 class="mb-3">CHANGES TO THIS PRIVACY POLICY

                            </h3>
                            <p>This Privacy Policy may be modified from time to time, so please review it frequently. Changes to this Privacy Policy will be posted on our websites. If we materially change the ways in which we use or share personal information
