    ...
    <main id="content" role="main" class="overflow-hidden">
        ...
        <div class="position-relative bg-primary overflow-hidden">
            <div class="container position-relative z-index-2 space-top-3 space-top-md-4 space-bottom-3 space-bottom-md-4">
                <div class="w-md-100 w-xl-60 text-center mx-md-auto">
                    <div class="mb-7">
                        <div class="min-w-10rem mr-2 mb-2 h-30">
                            <figure class="avatar mx-auto rounded-circle bg-soft-light" style="width: 4rem;height: 4rem; padding: .9rem;">
                                <i class="fab fa-wordpress text-white" style="font-size: 2.3rem;"></i>
                            </figure>
                    ...
                    <a class=" btn text-white" href="#planpricing">View Pricing <i class="fas fa-angle-right fa-sm ml-1"></i></a>
                </div>
            </div>
        ...
        <g opacity=".3">
          <linearGradient id="doubleEllipseTopLeftID1" gradientUnits="userSpaceOnUse" x1="2073.5078" y1="1.7251" x2="2273.4375" y2="1135.5818" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="0.4976" style="stop-color:#2899f0"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#1b77bd"/>
          </linearGradient>
          ...
          <linearGradient id="doubleEllipseTopLeftID2" gradientUnits="userSpaceOnUse" x1="1717.1648" y1="3.779560e-05" x2="1717.1648" y2="644.0417" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="1.577052e-06" style="stop-color:#2899f0"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#1b77bd"/>
          </linearGradient>
      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Managed WordPress cloud hosting Plan and Pricing </h2>
                    <p> Select the best Managed WordPress cloud hosting plan </p>
                </div>
                ...
                ">
                  ...
                  <i class="fas fa-wifi text-success"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class=" media font-size-1  text-body  mb-3 ">
                                        <i class="fas fa-check-circle text-success mt-1 mr-3"></i>
                                        <div class="media-body"> Free SSL </div>
                                    </div>
                                    <div class=" media font-size-1  text-body  mb-3 ">
                                        <i class="fas fa-check-circle text-success mt-1 mr-3"></i>
                                        <div class="media-body">Free Website Migration
                                        </div>
                                    </div>
                                    <div class=" media font-size-1  text-body  mb-3 ">
                                        <i class="fas fa-check-circle text-success mt-1 mr-3"></i>
                                        <div class="media-body">Unlimited App Installation
                                        </div>
                                    </div>
                                    <div class=" media font-size-1  text-body  mb-3 ">
                                        <i class="fas fa-check-circle text-success mt-1 mr-3"></i>
                      ...
                      Get Started
                        ...
                        <div class="col-sm-6 col-md-4 px-2 mb-3">
                            ...
                            <div class="card h-100">
                                <!-- Header -->
                                <div class="card-header text-center">
                                    <span class="d-block h5">Enterprise</span>
                                    <span class="d-block mb-2">
                      <span class="text-dark align-top curr_sym">₹</span>
                                    <span class="font-size-3 text-dark font-weight-bold mr-n2">
                        <span
                          id="pricingCount3Example2"
                          data-hs-toggle-switch-item-options='{
                                     "min": 13699,
                                     "max": 13599
                                   }'
            ...
            ">
                            <div class=" text-light text-left">
                                <div class="h3  text-light"> <i class="fas fa-cog text-light"></i> Need a Custom Server?</div>
                                <hr class="my-5">
                                <div class="row">
                           ...
                           <i class="fas fa-wifi "></i> </span>
                            ...
                            <div>
                                <a class="btn btn-light btn-sm font-weight-bold" style="white-space: nowrap;" href="#">Configure Now <span class="fas fa-angle-right ml-1"></span
                        ></a>
                            </div>
                        </div>
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose Our Managed WordPress Cloud Hosting Services?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We offer fully optimized and secure cloud servers that are designed to host WordPress websites and applications.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">All our WordPress cloud hosting services comes equipped with cPanel or Plesk control panels for effective management of hosting account.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our WordPress cloud hosting experts are available 24/7 to support you on any hosting-related issues or emergencies.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Hardware failures or data corruption are common and can happen anytime. Hence, we ensure your website and data security by performing regular backups.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We let you easily scale your servers or downgrade them according to the current business needs and requirements.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="position-relative bg-primary overflow-hidden ">
            <div class="container space-top-2 space-top-lg-3 position-relative z-index-2 ">
                ...
                <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9 ">
                    <h2 class="text-white ">Experience the real hosting experience</h2>
                    <p class="text-white-70 ">Migrate your WordPress website to our environment so that you never have to be worried about performance, data security, and uptime. Our expert team is capable of ensuring and smooth and seamless transition of the website from your
                        existing environment to ours.
                    </p>
            ...
            <figure class="w-35 position-absolute top-0 right-0 ">
                <div class="mt-n11 mr-n11 ">
                    <img class=" img-fluid " src="./assets/svg/components/half-circle-3.svg " alt="Image Description " style="filter: brightness(100);">
                </div>
            </figure>
