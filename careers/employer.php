...
<head>
  <!-- Title -->
  <title>Employer (Company) - Jobs | Front - Responsive Website Template</title>
 ...
 <header id="header" class="header header-box-shadow-on-scroll header-bg-light header-abs-top header-show-hide" data-hs-header-options='{
  ...
  <main id="content" role="main">
          ...
          <div class="media-body">
            <div class="row">
              ...
              <div class="col-lg-auto align-self-lg-end text-lg-right">
                <a class="btn btn-sm btn-primary mb-1 mb-sm-0 mr-1"  >54 Open jobs</a>
                <a class="btn btn-sm btn-outline-primary mb-1 mb-sm-0"  >
        ...
        <div id="pageHeaderTabParent">
          <div class="js-nav-scroller js-sticky-block hs-nav-scroller-horizontal bg-white"
            ...
            <ul class="js-scroll-nav nav nav-tabs page-header-tabs bg-white" id="pageHeaderTab" role="tablist"
              ...
              <li class="nav-item">
                <a class="nav-link" href="#jobs-section">Jobs <span class="badge badge-info badge-pill ml-1">+9</span></a>
              </li>
              <li class="nav-item">
              ...
              <li>
                ...
                <ul class="list-inline">
                  <li class="list-inline-item">
                    <a class="icon icon-xs icon-soft-dark icon-circle"   data-toggle="tooltip" data-placement="top" title="Capsule on Facebook">
                      <i class="fab fa-facebook"></i>
                    </a>
                  </li>
                  
                  <li class="list-inline-item">
                    <a class="icon icon-xs icon-soft-dark icon-circle"   data-toggle="tooltip" data-placement="top" title="Capsule on Twitter">
                      <i class="fab fa-twitter"></i>
                    </a>
                  </li>
                  
                  <li class="list-inline-item">
                    <a class="icon icon-xs icon-soft-dark icon-circle"   data-toggle="tooltip" data-placement="top" title="Capsule on Github">
    ...
    <div id="jobs-section" class="container">
      ...
      <!-- Slick Carousel -->
      <div class="js-slick-carousel slick slick-gutters-3 slick-equal-height mb-7"
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3 mb-3 mb-sm-5">
          <!-- Card -->
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.php">
            <div class="card-body">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.php">
            <div class="card-body">
              <div class="media align-items-center">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">UI/UX Design</h5>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.php">
            <div class="card-body">
              <div class="media align-items-center">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">Front-End Developer</h5>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-3 mb-sm-5">
          ...
          <a class="card card-bordered card-hover-shadow h-100" href="job-overview.php">
            <div class="card-body">
              <div class="media align-items-center">
                <div class="media-body">
                  <h5 class="text-hover-primary mb-0">Product Designer</h5>
      ...
      <a class="btn btn-link" href="jobs-list.php">View all available jobs <i class="fas fa-angle-right ml-1"></i></a>
    </div>
    <!-- Jobs Section -->
    ...
    <div id="reviews-section" class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mb-7 mb-lg-0">
          ...
          <a class="btn btn-link"  >View all reviews <i class="fas fa-angle-right ml-1"></i></a>
          ...
          <div id="stickyBlockStartPoint" class="pl-lg-4">
            ...
            <div class="js-sticky-block card card-bordered"
              ...
              <div class="card-body p-5">
                ...
                <a class="btn btn-sm btn-block btn-primary"  >Write a review</a>
    ...
    <div id="interview-section" class="container">
      ...
      <div class="mb-4">
        <h5>What candidates say about the interview process at Capsule</h5>
      </div>
      ...
      <a class="btn btn-link"  >View all interviews <i class="fas fa-angle-right ml-1"></i></a>
    </div>
    <!-- Rating Section -->
    ...
    <!-- Locations Section -->
    <div id="locations-section" class="container space-bottom-2">
      <div class="mb-4">
