...
<head>
    <!-- Title -->
    <title>Jobs | Front - Responsive Website Template</title>
...
<body>
  ...
  <header id="header" class="header header-box-shadow-on-scroll header-bg-transparent header-abs-top header-show-hide" data-hs-header-options='{
    ...
    <main id="content" role="main">
        <!-- Hero Section -->
        <div class="position-relative  gradient-x-three-sm-primary rounded-lg space-top-md-1 space-bottom-md-2 mx-md-10" style="margin-top:8rem">
                ...
                <div class="row position-relative z-index-2">
                    <div class="col-lg-8">
                        ...
                        <div class="w-lg-80 text-center text-lg-left mb-5 mb-lg-7">
                            <h1 class="display-4">Find the most<br><span class="text-primary text-highlight-warning">exciting</span>  jobs</h1>
                        </div>
                        <!-- End Title -->
        ...
        <div class="container space-2 space-top-lg-4 space-bottom-lg-3">
            ...
            <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-7">
                ...
                <p>Find a job you love. <a class="font-weight-bold"  >Set your career interests.</a></p>
            </div>
            <!-- End Title -->
                    ...
                    <div class="card card-bordered card-hover-shadow h-100">
                      ...
                      <span class="custom-checkbox-bookmark-active" data-toggle="tooltip" data-placement="top" title="Saved">
                        <i class="fas fa-star"></i>
                            ...
                            <h3 class="mb-3">
                                <a class="text-dark" href="employer.php">Senior B2B sales consultant</a>
                            </h3>
                    ...
                    <div class="card card-bordered card-hover-shadow h-100">
                      ...
                      <span class="custom-checkbox-bookmark-active" data-toggle="tooltip" data-placement="top" title="Saved">
                        <i class="fas fa-star"></i>
                            ...
                            <h3 class="mb-3">
                                <a class="text-dark" href="employer.php">Office assistant/Social media assistant</a>
                            </h3>
                    ...
                    <div class="card card-bordered card-hover-shadow h-100">
                      ...
                      <span class="custom-checkbox-bookmark-active" data-toggle="tooltip" data-placement="top" title="Saved">
                        <i class="fas fa-star"></i>
                            ...
                            <h3 class="mb-3">
                                <a class="text-dark" href="employer.php">Marketing and Communications Manager</a>
                            </h3>
                    ...
                    <div class="card card-bordered card-hover-shadow h-100">
                      ...
                      <span class="custom-checkbox-bookmark-active" data-toggle="tooltip" data-placement="top" title="Saved">
                        <i class="fas fa-star"></i>
                            ...
                            <h3 class="mb-3">
                                <a class="text-dark" href="employer.php">Senior backend developer</a>
                            </h3>
                    ...
                    <div class="card card-bordered card-hover-shadow h-100">
                      ...
                      <span class="custom-checkbox-bookmark-active" data-toggle="tooltip" data-placement="top" title="Saved">
                        <i class="fas fa-star"></i>
                            ...
                            <h3 class="mb-3">
                                <a class="text-dark" href="employer.php">Senior product manager</a>
                            </h3>
                    ...
                    <div class="card card-bordered card-hover-shadow h-100">
                      ...
                      <span class="custom-checkbox-bookmark-active" data-toggle="tooltip" data-placement="top" title="Saved">
                        <i class="fas fa-star"></i>
                            ...
                            <h3 class="mb-3">
                                <a class="text-dark" href="employer.php">iOS Engineer</a>
                            </h3>
            ...
            <div class="text-center">
                <a class="btn btn-link" href="job-list.php">View all jobs <i class="fas fa-angle-right ml-1"></i></a>
            </div>
        </div>
        <!-- End Listing Section -->
        ...
        <div class="container space-2 space-lg-3">
            ...
            <div class="text-center">
                <a class="btn btn-link" href="job-list.php">View all startups <i class="fas fa-angle-right ml-1"></i></a>
            </div>
        </div>
        <!-- End Listing Section -->
    </main>
