    ...
    <div id="logoAndNav" class="container">
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg">
            ...
            <a class="navbar-brand" href="./index.php" aria-label="Front">
                <img height="50" width="200" src="./assets/svg/logos/cloog-new.svg" alt="Logo">
            </a>
            <!-- End Logo -->

            <!-- Responsive Toggle Button -->
            <button type="button" class="navbar-toggler btn btn-icon btn-sm btn-soft-dark rounded-circle" aria-label="Toggle navigation" aria-expanded="false" aria-controls="navBar" data-toggle="collapse" data-target="#navBar">
                ...
                <div class="navbar-body header-abs-top-inner">
                    <ul class="navbar-nav">
                        ...
                        <li class="hs-has-mega-menu navbar-nav-item" data-hs-mega-menu-item-options='{
                            ...
                            <!-- Demos - Mega Menu -->
                            <div class="hs-mega-menu dropdown-menu w-100 responsiveheader" aria-labelledby="demosMegaMenu" style="min-width: 330px;left: 30%;">
                                <div class="row no-gutters">
                                    <div class="col-lg-12">
                                        <div class="navbar-promo-card-deck">
                                            <!-- Promo Item -->
                        ...
                        <li class="hs-has-mega-menu navbar-nav-item" data-hs-mega-menu-item-options='{
                            ...
                            <!-- Demos - Mega Menu -->
                            <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="docsMegaMenu">
                                <div class="row no-gutters">
                                    <div class="col-lg-12">
                                        <div class="navbar-promo-card-deck">
                                            <!-- Promo Item -->
                        ...
                        <li class="hs-has-mega-menu navbar-nav-item" data-hs-mega-menu-item-options='{
                            ...
                            <a id="docsMegaMenu2" class="hs-mega-menu-invoker nav-link nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false"> Other Services</a>

                            <!-- Docs - Submenu -->
                            <div class="hs-mega-menu dropdown-menu responsiveheader" aria-labelledby="docsMegaMenu2" style="min-width: 330px;left: 60%;">
                                <!-- Promo Item -->
                        ...
                        <li class="navbar-nav-last-item pl-0">
                            <div class="dropdown show currencydd">
                                <a class=" btn btn-sm btn-light-outline dropdown-toggle p-1 ddtoggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
