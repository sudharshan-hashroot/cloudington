...
<div class="row">
    <div class="col-12 col-md-6 text-left text-white my-auto">
        ...
        <small class="btn btn-xs btn-soft-light btn-rounded text-uppercase font-weight-bold mb-2">SECURE & TRUSTED</small>     
        <h1 class="font-weight-bold text-white">Managed VPS Hosting Service Provider</h1>
        <p>Enjoy hassle-free and secure managed VPS hosting service at an affordable price. Our hosting experts are available 24/7 to take complete care of your hosting server and ensure its optimal performance. Choose any of our hosting plans to get your website online and enjoy unmatched performance.
        </p>
    ...
    <div class="col-12 col-md-6 text-left text-white my-auto">
<img src="./assets/img/landingpage/vps.png" class="w-100" data-aos="fade-up" alt="">
    </div>
</div>
            </div>
        </div>
        ...
        <div class="overflow-hidden" id="planpricing">
            <div class="container pb-4 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Our Managed VPS Hosting Plans </h2>
                    ...
                    <div class="col-lg-7">
                        <div class="position-relative">
                            ...
                            <div class="device d-none d-sm-block mb-3 mb-sm-0" data-aos="fade-up">
                                ...
                                <img class=" device-macbook-screen" src="./assets/img/1920x1080/vps2.png" alt="Image Description">
                            </div>
                            <!-- End Device Mockup -->
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Our VPN Hosting Service Benefits </h2>
                ...
                <div class="col-sm-6 col-lg-4 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4> Fully managed </h4>
                            <p class="font-size-1 text-body mb-0 ">Get fully managed services as part of our VPS hosting service offering. We offer 24/7 dedicated support and ensure your server is operating at maximum efficiency without any issues.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">With our VPS hosting service, we will ensure to keep your server protected and secure with constant security patch updates, dedicated firewalls, and other security tools.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-4 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We will perform regular data backups and allows you to easily recover it in case of any accidental deletion or corruption of data.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-4 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Scalability</h4>
                            <p class="font-size-1 text-body mb-0 ">According to your current business requirements, you can easily upgrade your server resources or downgrade them without any interruptions.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-4 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">By choosing our managed VPS hosting plans, you will get an hosting environment that is fully optimized and offer top-notch performance.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-4 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">With our managed VPS hosting service, your application will be up and running 24/7 without any faults. We will continuously monitor all the operations and any issues arising will be resolved instantly.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="bg-primary text-center bg-img-hero position-relative overflow-hidden" style=" background-image: url(./assets/svg/components/abstract-shapes-5.svg); ">
            ...
            <div class="container space-2 ">
                <div class="mb-5 ">
                    <h2 class="text-white ">Fully Managed VPS Hosting for Websites</h2>
                    <p class="text-white ">Get unmatched performance and increased flexibility with our managed VPS hosting services. We will help you customize the hosting environment according to your requirements without having to pay anything extra.
                    </p>
                </div>
        ...
        <div class="container space-2">
            ...
            <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                <h2 class="h1">Why Choose us as your VPS Hosting Service Provider?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3">
                    ...
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            ...
                            <p class="font-size-1 text-body mb-0">Our support executives are available 24/7 to offer quick and effective support to our customers.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3">
                    ...
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            ...
                            <h4>Control Panel Feature
                            </h4>
                            <p class="font-size-1 text-body mb-0">Our VPS hosting service comes equipped with either Plesk or cPanel control panel for easy and effective management of your hosting account. </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3 mb-sm-0">
                    ...
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            ...
                            <p class="font-size-1 text-body mb-0">All our managed VPS hosting plans are designed to meet your hosting requirements at an affordable price.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3 mb-sm-0">
                    ...
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            ...
                            <h4>Guaranteed Uptime
                            </h4>
                            <p class="font-size-1 text-body mb-0">Get guaranteed uptime and fast servers by choosing for our hosting service. We offer a 99.9% guaranteed uptime SLA.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
            ...
            <div id="basicsAccordion">
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingOne">
                        ...
                        How secure is your managed VPS hosting Service?                     
              ...
              <span class="card-btn-toggle-active">−</span>
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingThree">
                        ...
                        Will I be able to upgrade to another VPS hosting plan later?
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseThree" class="collapse" aria-labelledby="basicsHeadingThree" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Yes. You can easily upgrade your plan according to your requirements. Share your requirements with us and we will help you scale your hosting plan instantly.
                            </p>
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>We guarantee to keep your site live and running 99.9% of the time. Our experts work round the clock to keep your data protected and safe.
                            </p>
