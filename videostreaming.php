                ...
                <div class="w-md-100 w-xl-60 text-center mx-md-auto">
                    <div class="mb-7">
                        ...
                        <p class=" text-white mb-4">
                            ...
                            will get to enjoy by choosing our video stream hosting service.</p>
                    </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1246 1078">
                    <g opacity=".7">
                        <linearGradient id="doubleEllipseTopLeftID1" gradientUnits="userSpaceOnUse" x1="2073.5078"
                            ...
                            <stop class="stop-color-primary-lighter" offset="0.4976" style="stop-color:#21325b" />
                            <stop class="stop-color-primary" offset="1" style="stop-color:#314269" />
                        </linearGradient>
                        ...
                        <linearGradient id="doubleEllipseTopLeftID2" gradientUnits="userSpaceOnUse" x1="1717.1648"
                            ...
                            <stop class="stop-color-primary-lighter" offset="1.577052e-06" style="stop-color:#21325b" />
                            <stop class="stop-color-primary" offset="1" style="stop-color:#314269" />
                        </linearGradient>
          ...
          ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Video Stream Hosting Service Plan and Pricing </h2>
                    <p>Select the best Video Streaming plan</p>
                </div>
                ...
                ">
                            ...
                            <div>
                                <a class="btn btn-light btn-sm font-weight-bold" style="white-space: nowrap;"
                                    href="#">Configure
                                    Now <span class="fas fa-angle-right ml-1"></span></a>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">With regular monitoring and effective management of
                                the hosting server, we guarantee to keep your streaming service up and running 99.9% of
                                the time. </p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Control Panel Powered
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">Our video stream hosting plans include a control
                                panel offering for effective management of the hosting account.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Low Latency</h4>
                            <p class="font-size-1 text-body mb-0 ">Choose our hosting plans and get your video stream
                                delivered to millions of audiences without any delay. </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>24/7 Support</h4>
                            <p class="font-size-1 text-body mb-0 ">Our video stream hosting is backed by 24/7 support
                                services to assist you in solving any issues or challenges.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Best Quality Stream </h4>
                            <p class="font-size-1 text-body mb-0 ">Host with us and start delivering the best-quality
                                video streams to your audiences anywhere in the world.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our hosting service lets you easily resize your
                                server up or down based on the current demand.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="position-relative bg-primary overflow-hidden ">
            <div class="container space-top-2 space-top-lg-3 position-relative z-index-2 ">
                ...
                <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9 ">
                    <h2 class="text-white ">Affordable and Scalable Video Stream Hosting </h2>
                    <p class="text-white-70 ">Demand for online video continues to grow. By partnering with a video
                        stream hosting provider such as Cloudigton, content providers can deliver videos of exceptional
                        quality to their users with ease. Our hosting experts are highly
                        talented and are available 24/7 to assist you. </p>
            ...
            <div id="basicsAccordion">
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingOne">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0"
                            href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseOne"
                    ...
                    <div id="basicsCollapseOne" class="collapse" aria-labelledby="basicsHeadingOne"
                        ...
                        <div class="card-body px-0">
                            <p>We offer a 99.9% uptime guarantee on our hosting services.</p>
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingThree">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0"
                            href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseThree"
                            aria-expanded="false" aria-controls="basicsCollapseThree">
                            How secure is your video hosting service?
                    ...
                    <div id="basicsCollapseThree" class="collapse" aria-labelledby="basicsHeadingThree"
                        data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Your hosting servers are continuously monitored for any vulnerabilities and get it
                                resolved instantly. Moreover, we even keep your server up to date by installing
                                important security patches and other software updates. </p>
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingFour">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0"
                            href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseFour"
                    ...
                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour"
                        data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Our hosting experts are available round-the-clock to support you and help you solve any
                                issues or challenges you are facing. We strive to offer the best services to our
                                customers. </p>
