...
<body>
    ...
    <main id="content" role="main" class="overflow-hidden">
        <!-- Hero Section -->
        <div class="position-relative bg-orange overflow-hidden">
                    ...
                    <div class="mb-7">
                        <div class="min-w-10rem mr-2 mb-2 h-30">
                            <figure class="avatar mx-auto rounded-circle bg-soft-light" style="width: 4rem;height: 4rem; padding: .9rem;">
                                <i class="fab fa-magento text-white" style="font-size: 2.3rem;"></i>
                            </figure>
        ...
        <g opacity=".4">
          <linearGradient id="doubleEllipseTopLeftID1" gradientUnits="userSpaceOnUse" x1="2073.5078" y1="1.7251" x2="2273.4375" y2="1135.5818" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="0.4976" style="stop-color:#FA9F42"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#f38516"/>
          </linearGradient>
          ...
          <linearGradient id="doubleEllipseTopLeftID2" gradientUnits="userSpaceOnUse" x1="1717.1648" y1="3.779560e-05" x2="1717.1648" y2="644.0417" gradientTransform="matrix(-1 0 0 1 2600 0)">
            <stop class="stop-color-primary-lighter" offset="1.577052e-06" style="stop-color:#FA9F42"/>
            <stop class="stop-color-primary" offset="1" style="stop-color:#f38516"/>
          </linearGradient>
      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Managed Magento cloud hosting Plan and Pricing
                    </h2>
                    <p>Select the best Managed Magento cloud hosting plan </p>
                </div>
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Our Managed Magento Cloud Hosting?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Proactive Security
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">With daily malware scans, dedicated firewalls, and other security systems in place, we ensure the safety of your website.</p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Easily scale your server resources to withstand any traffic surges based on the current business demands.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Regular monitoring of your servers to identify vulnerabilities and prevent any sort of attacks affecting your website.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">With advanced caching technologies and CDN systems, we ensure to offer a fully optimized Magento cloud hosting environment. </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">With our managed Magento cloud hosting, we ensure to keep your server up to date by installing server security patches and critical software.</p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
