                    ...
                    <div class="mb-7">
                        <div class="min-w-10rem mr-2 mb-2 h-30">
                            <figure class="avatar mx-auto rounded-circle bg-soft-light" style="width: 4rem;height: 4rem; padding: .9rem;">
                                <i class="fas fa-server text-white" style="font-size: 2rem;"></i>
                            </figure>

                        </div>
                        <h1 class="display-4 text-white mb-4">cPanel Hosting Service

                        </h1>
                        <p class=" text-white mb-4">cPanel is the most popular and widely used control panel tool for website hosting. Our cPanel cloud hosting comes with a host of services and useful features for effective hosting and management of your website. The user-friendly
                            graphical interface of the control panel will help you establish a smooth interaction with the webserver and allows you to effectively manage your hosting account. Improved website performance, enhanced security, and guaranteed
                            uptime are some of the benefits you get to enjoy by choosing our cPanel cloud hosting service..
      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">cPanel Cloud Hosting Plan and Pricing</h2>
                    <p>Select the best cPanel hosting Plan to get started</p>
                </div>
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose our cPanel Cloud Hosting Service?
                </h2>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Choose any of our plans and share your requirements with us to get your servers up and running instantly.
                            </p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our cPanel hosting comes equipped with a plethora of features that offer a unique hosting experience.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <h4>Round-the-clock Support
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">Our hosting experts are available 24/7 to support you and get your issues resolved instantly.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <h4>High-Speed Hosting
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">Speed of your website matters in today's world. Our cPanel hosting is designed to offer unmatched website performance.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <h4>Secure and Reliable
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">Our cPanel hosting comes with built-in security features that help ensure the safety of your server and website.
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover "  >
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">All our cPanel cloud hosting plans come up with the absolute cheapest price that everyone can afford.
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseOne" class="collapse" aria-labelledby="basicsHeadingOne" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>cPanel is a control panel that lets you manage your web hosting account via an easy-to-use graphical interface. cPanel offers a host of features and options that lets you take complete control of your hosting account.
                            </p>
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>By following some of the industry's best security practices, we guarantee to keep your website live and running 99.9% of the time.
                            </p>
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFive" class="collapse" aria-labelledby="basicsHeadingFive" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Yes. We offer fully managed hosting services, in which we will completely take care of your hosting account. Our cloud experts are available 24/7 to assist you in case of any emergencies.
                            </p>
