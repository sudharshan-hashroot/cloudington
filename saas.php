      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">Cloud for Startups Plan and Pricing </h2>
                    <p> Select the best cloud hosting plans for Startups </p>
                </div>
        ...
        <div class="container space-2">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9">
                <h2 class="h1">Why Choose Our Managed Cloud for Startups? </h2>
            </div>
            <!-- End Title -->
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0">
                    ...
                    <i class="fas fa-cogs"></i>
                            ...
                            <p class="font-size-1 text-body mb-0">
                                No more waiting, get your website or application deployed instantly and easily with the help of our managed cloud hosting for startups.
            ...
            <div class="row mx-n2 mb-3">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0">
                    ...
                    <i class="fas fa-globe"></i>
                            ...
                            <p class="font-size-1 text-body mb-0">
                                With data centers at multiple locations, it is easy for you to host your website at locations close to your customers and offer an optimal user experience.
            ...
            <div class="row mx-n2 mb-3">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0">
                    ...
                    <i class="fas fa-user-cog"></i>
                            ...
                            <h4>Fully Managed</h4>
                            <p class="font-size-1 text-body mb-0">
                                Your hosting environment will be fully managed by our team of experts and ensure its optimal performance.
        ...
        <div id="saasAccordion">
          ...
          <div class="card shadow-none mb-3">
            ...
            <div class="card shadow-none mb-3">
                ...
                How secure is your hosting service?
                 <span class="card-btn-toggle">
                  <span class="card-btn-toggle-default">&plus;</span>
                  <span class="card-btn-toggle-active">&minus;</span>
                </span>
                ...
                <div id="saasCollapseTwo" class="collapse" aria-labelledby="saasHeadingTwo" data-parent="#saasAccordion">
                    <div class="card-body px-0">
                        <p>
                            With two-factor authentication, dedicated firewalls, regular security patches, and firmware upgrades, we guarantee to keep your cloud server secure and protected.
            ...
            <div class="card shadow-none mb-3">
                ...
                <div id="saasCollapseThree" class="collapse" aria-labelledby="saasHeadingThree" data-parent="#saasAccordion">
                    <div class="card-body px-0">
                        <p>
                            We have a dedicated team of cloud engineers who are available 24/7 to support you on any queries. We strive to offer the best support service to our clients.
                        </p>
                    </div>
                </div>
            </div>
