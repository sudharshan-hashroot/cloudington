                ...
                Back 
                 ...
                 "stickyOffsetBottom": 0
                    ...
                    "targetSelector": "#selectRegion"
                            ...
                            <li class="step-item">
                                <a class="step-content-wrapper" onclick="compareinstance();" href="javascript:;" data-hs-step-form-next-options='{
                    "targetSelector": "#postJobStepAddress"
                  }'>
                                    <span class="step-icon step-icon-soft-dark">3</span>
                                    <div class="step-content">
                                        <span class="step-title">Server Instance</span>
                                        <span class="step-title-description step-text font-size-1">Select Server Instance</span>
                                    </div>
                                </a>
                            </li>
                        ...
                        <div id="postJobStepBasic" class="card active">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-end align-items-center">
                                    <a type="button" class="btn btn-primary" data-hs-step-form-next-options='{
                            "targetSelector": "#selectRegion"
                          }'>
...
<option value="ZW" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle mr-2" src="./node_modules/flag-icon-css/flags/1x1/zw.svg" alt="Zimbabwe Flag" /><span class="text-truncate">Zimbabwe</span></span>'>Zimbabwe</option>
                            ...
                            <div class="card-footer">
                                <div class="d-flex align-items-center">
                                    <button type="button" onclick="resetLoad();" class="btn btn-ghost-secondary" data-hs-step-form-prev-options='{
"targetSelector": "#postJobStepBasic"
}'>
<i class="fas fa-angle-left mr-1"></i> Previous 
                                    ...
                                    <div class="ml-auto">
                                        <button type="button" onclick="compareinstance();" class="btn btn-primary" data-hs-step-form-next-options='{
      "targetSelector": "#postJobStepAddress"
    }'>
Continue <i class="fas fa-angle-right ml-1"></i>
</button>
                            ...
                            <div class="card-body ">
                                ...
                                ">
                                  ...
                                  <i class="fas fa-wifi text-success"></i>
                                            ...
                                            <div class="col-6 col-md-6 px-2 digital_col">
                                                <div class="custom-control custom-radio custom-control-inline checkbox-outline checkbox-icon text-center w-100 h-100">
                                                    <input type="radio" id="doinstance" name="instancetype" class="custom-control-input checkbox-outline-input checkbox-icon-input" checked>
                                                    <label class="checkbox-outline-label checkbox-icon-label w-100 rounded py-3 px-1 mb-0" for="doinstance">
                                                        ...
                                                        <b> <span class="d-block dname"> Cloud D1</span></b>
                                               
                                                <small class="ddesc"></small>
                                                <hr>
                                                <div class="card-body p-1 text-left">
                                                    <div class="
                                        media
                                ...
                                ">
                                  ...
                                  <i class="fas fa-wifi text-success"></i>
                                                        ...
                                                        <div class="media-body w-50">Bandwidth</div>
                                                        <div class="media-body pl-2">
                                                            <b class="dband">2 TB</b>
                                                        </div>
                                                    </div>
                                           
                                                </div>
                                                <hr>
                                                <div class="btn btn-soft-primary btn-block dprice">₹ 499</div>
                                              </label>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-6 px-2 linode_col">
                                                <div class="custom-control custom-radio custom-control-inline checkbox-outline checkbox-icon text-center w-100 h-100">
                                                    ...
                                                    <label class="checkbox-outline-label checkbox-icon-label w-100 rounded py-3 px-1 mb-0" for="linodeinstance">
                                                        ...
                                                        <b> <span class="d-block lname">Cloud LS1</span></b>
                                               
                                                <small class="ldesc"></small>
                                                <hr>
                                                <div class="card-body p-1 text-left">
                                                    <div class="
                                        media
                                ...
                                ">
                                  ...
                                  <i class="fas fa-wifi text-success"></i>
                                                        ...
                                                        <div class="media-body w-50">Bandwidth</div>
                                                        <div class="media-body pl-2">
                                                            <b class="lband">2 TB</b>
                                                        </div>
                                                    </div>
                                           
                                                </div>
                                                <hr>
                                                <div class="btn btn-soft-primary btn-block lprice">₹ 499</div>
                                              </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-12 text-center">
                                                <a type="button" onclick="showalltab();" class="btn btn-outline-primary my-4 ">Show all Instances <i class="fas fa-angle-down ml-1"></i></a>
                                            </div>

                                        </div>
                                        <!-- End Radio Checkbox Group -->

                                        <div id="instancetable" class="closeup">
                                            <!-- Tabs -->
                                            <div class="w-lg-80 mx-lg-auto">
                                                <ul class="nav nav-pills  tablemobile bg-primary nav-segment  w-100 nav-dark nav-justified scrollbar-horizontal font-weight-bold" role="tablist">
                                                    <li class="nav-item c_tab">
                                                        <a class="nav-link active" id="pills-three-code-sample-tab" data-toggle="pill" href="#pills-three-code-sample" role="tab" aria-controls="pills-three-code-sample" aria-selected="false">
                                                            <figure class="py-2">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade show active pt-5" id="pills-three-code-sample" role="tabpanel" aria-labelledby="pills-three-code-sample-tab">
                                                    <div class=" ">
