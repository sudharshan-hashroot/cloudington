...
<head>
  <!-- Title -->
  <title>Employee (Applicant) - Jobs | Front - Responsive Website Template</title>
          ...
          <div class="media-body">
            <div class="row">
              ...
              <div class="col-lg-auto align-self-lg-end text-lg-right">
                <a class="btn btn-sm btn-primary mb-1 mr-1"  >
    ...
    <div class="container space-2">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="mb-8">
            ...
            <ul class="step step-icon-sm">
              <li class="step-item">
                <div class="step-content-wrapper">
                  <div class="step-avatar step-avatar-sm">
                    <img    class=" step-avatar-img" src="../assets/svg/brands/spec.svg" alt="Image Description">
                  </div>
              ...
              <li class="step-item">
                <div class="step-content-wrapper">
                  <div class="step-avatar step-avatar-sm">
                    <img    class=" step-avatar-img" src="../assets/svg/brands/mailchimp.svg" alt="Image Description">
                  </div>
                  <div class="step-content">
              ...
              <li class="step-item">
                <div class="step-content-wrapper">
                  <div class="step-avatar step-avatar-sm">
                    <img    class=" step-avatar-img" src="../assets/svg/brands/google.svg" alt="Image Description">
                  </div>
                  <div class="step-content">
            ...
            <ul class="step step-icon-sm">
              <li class="step-item">
                <div class="step-content-wrapper">
                  ...
                  <div class="step-content">
                    <h5>Master's degree in Computer Software Engineering</h5>
              ...
              <li class="step-item">
                <div class="step-content-wrapper">
                  ...
                  <div class="step-content">
                    <h5>Bachelor's degree in Computer Software Engineering</h5>
          ...
          <ul class="list-unstyled list-sm-article">
            <li>
              <a  >www.github.com/maria-w</a>
            </li>
            <li>
              <a  >www.twitter.com/maria-w</a>
            </li>
          </ul>
          ...
          <div id="stickyBlockStartPoint" class="pl-lg-4">
            ...
            <div class="js-sticky-blocks card card-bordered"
              ...
              <div class="card-body p-5">
                ...
                <a class="btn btn-sm btn-block btn-soft-dark"  >Select a subscription</a>
