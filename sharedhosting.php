...
<div class="row">
    ...
    <div class="col-12 col-md-6 text-left text-white my-auto">
<img src="./assets/img/landingpage/shared.png" class="w-100" data-aos="fade-up" alt="">
    </div>
</div>
            </div>
        </div>
        <!-- <div class="gradient-x-overlay-sm-indigo position-relative overflow-hidden">
            <div class="position-relative">
                <span class="position-absolute icon icon-lg icon-soft-primary icon-circle" style="    right: -1rem;
                top: 14rem;
                opacity: 0.5;
                height: 20rem;
                width: 20rem;
            ...
            <div class="container space-top-3 space-top-lg-4 space-bottom-3">
                <div class="w-lg-60 text-center mx-lg-auto">
                    <div class="" style="margin-bottom: 3rem;">
                        <h3 class="text-cap font-weight-bold text-primary" style="margin-bottom: 1rem;">Affordable Hosting </h3>
                        <h1 class="" style="
    margin-bottom: 2rem;"> <span class="text-dark font-weight-bold">Secure & Reliable Hosting Service
                    ...
                    <a class="btn btn-soft-primary transition-3d-hover" href="#planpricing">Check Our Plan  </a>
            ...
            <div class="container pb-4 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-3">
                    <div class="min-w-8rem mr-2 mb-2">
                        <div class="avatar d-flex justify-content-center align-items-center bg-soft-primary rounded p-2 mx-auto">
                            <h2 class="m-0"><i class="fas fa-server text-primary mb-2"></i></h2>
                        </div>
                    </div>
                    <h2 class="h1">Our Shared Website Hosting Plan and Pricing</h2>
                    <!-- <p>Select the best shared hosting plan for your website </p> -->
                </div>
                <!-- End Title -->
                <!-- Card -->
                <div class="">
                ...
                <span class="text-dark align-top curr_sym">$</span>
                 ...
                 <?php echo $s3_inr; ?> 
                    ...
                    ?>
                                ...
                                <div class="col-sm-6 d-none col-md-6 col-lg-4 px-2 mb-3">
                                    <!-- Pricing -->
                                    <div class="card h-100">
                                        <!-- Header -->
                                        <div class="card-header text-center flex-column">
                    ...
                    <div class="col-lg-7">
                        <div class="position-relative">
                            ...
                            <div class="device d-none d-sm-block mb-3 mb-sm-0" data-aos="fade-up">
                                ...
                                <img class=" device-macbook-screen" src="./assets/img/1920x1080/sharedhostingsection.jpg" alt="Image Description">
                            </div>
                            <!-- End Device Mockup -->
        ...
        <div class="container space-2">
            ...
            <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                ...
                <h2 class="h1">Our Shared Hosting Plan Features </h2>
            </div>
            <!-- End Title -->
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Get 24/7 expert support as a part of our shared hosting plan. All our support professionals have the right technical expertise required to assist you on hosting-related services.
                            </p>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our shared hosting plan comes equipped with a cPanel or Plesk control panel that allows you to take full control of your website.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">With our shared hosting plan, get the adequate bandwidth needed to manage large number of visitors to your website.
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>SSL Security </h4>
                            <p class="font-size-1 text-body mb-0 ">Our shared hosting plan comes with SSL encryption that helps keep your personal information and transactions protected.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We ensures your website data security. We will create regular backups for your website and help keep your data secure and protected.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>Instant Setup</h4>
                            <p class="font-size-1 text-body mb-0 ">We will help you to get your website up and running quickly and easily. Our team of well-skilled experts will also manage your hosting environment efficiently.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="bg-primary text-center bg-img-hero position-relative overflow-hidden" style=" background-image: url(./assets/svg/components/abstract-shapes-5.svg); ">
            ...
            <div class="container space-2 ">
                <div class="mb-5 ">
                    <h2 class="text-white ">Affordable and Powerful Web Hosting Solution</h2>
                    <p class="text-white ">Our shared website hosting plan is suitable for business owners who are looking for a fully functional and affordable hosting solution to host their website. All our hosting plan come equipped with a user-friendly control panel that
                        lets you manage and customize your website.
                    </p>
                </div>
        ...
        <div class="container space-2">
            ...
            <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                <h2 class="h1">Why Choose us as your Shared Hosting Company? </h2>

            </div>
            <!-- End Title -->

            <div class="row mx-n2">
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3">
                    <!-- Icon Blocks -->
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            <figure class="w-100 max-w-8rem mb-4 ">
                            ...
                            <p class="font-size-1 text-body mb-0">Our shared hosting service comes with a 99.9% guaranteed uptime SLA. </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3">
                    ...
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            ...
                            <p class="font-size-1 text-body mb-0">Our shared website hosting plans have been designed to get your site up and running at an affordable price. </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3 mb-sm-0">
                    <!-- Icon Blocks -->
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            <figure class="w-100 max-w-8rem mb-4 ">
                            ...
                            <h4>Highly Optimized Environment</h4>
                            <p class="font-size-1 text-body mb-0">All our servers are highly optimized to provide unmatched performance and maximum efficiency. </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-3 mb-sm-0">
                    ...
                    <a class="card h-100 transition-3d-hover">
                        <div class="card-body">
                            ...
                            <p class="font-size-1 text-body mb-0">We have years of expertise in providing shared website hosting services to customers all over the world.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseOne" class="collapse" aria-labelledby="basicsHeadingOne" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>In shared hosting, multiple websites are hosted on a single server. i.e, server resources are shared between websites. However, there are limits on the amount of resources that can be used and this limit is defined by the hosting
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingThree">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0" href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseThree" aria-expanded="false" aria-controls="basicsCollapseThree">
                            How secure is your Shared hosting service?  
            <span class="card-btn-toggle">
              <span class="card-btn-toggle-default">+</span>
              <span class="card-btn-toggle-active">−</span>
            </span>
                    ...
                    <div id="basicsCollapseThree" class="collapse" aria-labelledby="basicsHeadingThree" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>With dedicated firewalls on all servers and advanced levels of security practices, we keep your data safe and protected.</p>
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>No. Our experts work 24/7 to ensure that your website is live all the time without any interruptions. We will monitor your server for any anomalies and get them resolved at the initial stage itself.
                            </p>
