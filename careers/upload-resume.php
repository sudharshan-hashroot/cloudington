...
<head>
  <!-- Title -->
  <title>Upload Resume - Jobs | Front - Responsive Website Template</title>
            ...
            <div id="uploadResumeStepFormContent">
              ...
              <div id="uploadResumeStepBasics" class="card active">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="firstName" id="firstNameLabel" placeholder="Maria" aria-label="Maria">
                  </div>
                  <!-- End Form Group -->
              ...
              <div id="uploadResumeStepTypeOfJob" class="card" style="display: none;">
                ...
                <div class="card-body">
                  ...
                  <!-- Form Group -->
                  <div class="form-group">
                    <label class="input-label">Desired salary</label>
                  ...
                  <div class="js-add-field form-group"
                    ...
                    <div id="addLinksFieldTemplate" style="display: none;">
                      <input type="text" class="form-control mt-2" data-name="links" placeholder="https://www.maria.com" aria-label="https://www.maria.com">
                    </div>
            ...
            <div id="successMessageContent" style="display: none;">
              <div class="text-center">
                ...
                <div class="d-flex justify-content-center">
                  <a class="btn btn-primary" href="employee.php">
    ...
    $(document).on('ready', function () {
      ...
      $('.js-step-form').each(function () {
        var stepForm = new HSStepForm($(this), {
          finish: function() {
            $("#uploadResumeStepFormProgress").hide();
            $("#uploadResumeStepFormContent").hide();
