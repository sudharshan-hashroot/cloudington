            ...
            <div class="container position-relative z-index-2 space-top-3 space-top-md-4 space-bottom-3 space-bottom-md-4">
                <div class="w-md-100 w-xl-60 text-center mx-md-auto">
                    <div class="mb-7">
                        ...
                        <h1 class="display-4 text-white mb-4">Managed WooCommerce Hosting
                        </h1>
                        <p class=" text-white mb-4">Get reliable, affordable, and easy-to-scale managed WooCommerce hosting service for your online store. Our WooCommerce cloud hosting comes with a host of features and services that help improve store speed, user experience and
                            drive business growth. Our team of cloud engineers will help you get your WooCommerce server deployed and optimized instantly without any delay. </p>
                    </div>
      ...
      ">
            ...
            <div class="container mt-3 space-2">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    ...
                    <h2 class="h1">WooCommerce Cloud Hosting Plan and Pricing</h2>
                    <p> Select the best WooCommerce cloud hosting plan</p>
                </div>
        ...
        <div class="container space-2 ">
            ...
            <div class="w-md-80 w-lg-90 text-center mx-md-auto mb-5 mb-md-9 ">
                <h2 class="h1 ">Why Choose Our Managed WooCommerce Hosting Service?
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <h4>24/7 Expert Support
                            </h4>
                            <p class="font-size-1 text-body mb-0 ">Our WooCommerce hosting service is backed by 24/7 dedicated support to assist you in solving any issues that arise.
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our cloud servers are fully optimized to host your WooCommerce store and guarantee to offer unmatched performance even under heavy load.
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Our engineers will take care of your cloud server and optimize it accordingly to offer the best performance without any issues.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">Easily scale your WooCommerce hosting server resources to meet the current demands and requirements.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-lg-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">No more waiting period. Choose any of our hosting plans to get your cloud server deployed instantly in minutes.
                ...
                <div class="col-sm-6 col-lg-6 px-2 mb-3 mb-sm-0 ">
                    ...
                    <a class="card h-100 transition-3d-hover ">
                        <div class="card-body ">
                            ...
                            <p class="font-size-1 text-body mb-0 ">We regularly back up and keep your store data safe and secured. You can also easily restore this backed-up data in case of any emergencies.
                            </p>
                        </div>
                        <div class="card-footer border-0 pt-0 ">
        ...
        <div class="position-relative bg-primary overflow-hidden ">
            <div class="container space-top-2 space-top-lg-3 position-relative z-index-2 ">
                ...
                <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9 ">
                    <h2 class="text-white ">Affordable & Secure WooCommerce Hosting with Expert Support
                    </h2>
                    <p class="text-white-70 ">Our managed WooCommerce hosting comes with cloud servers that are fine-tuned and completely optimized to host WooCommerce stores. To add to that, we will completely take care of your server and ensure that it offers the best possible
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingOne">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0" href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseOne" aria-expanded="false" aria-controls="basicsCollapseOne">
                            What is managed WooCommerce cloud hosting?
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseOne" class="collapse" aria-labelledby="basicsHeadingOne" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>With managed WooCommerce hosting, we will take care of all your hosting-related needs and ensure the optimal performance of your cloud environment.
                            </p>
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingThree">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0" href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseThree" aria-expanded="false" aria-controls="basicsCollapseThree">
                            How safe is my online store if I choose your WooCommerce cloud hosting service?
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseThree" class="collapse" aria-labelledby="basicsHeadingThree" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>With SSL encryption, dedicated firewalls, regular updates, and backups, we ensure the security of your server and store.
                            </p>
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Yes. We do offer custom-tailored hosting packages that suit your business requirement. Get in touch with us to know more.
                            </p>
                ...
                <div class="card shadow-none mb-3">
                    <div class="card-header card-collapse" id="basicsHeadingFive">
                        <a class="btn btn-link btn-block d-flex justify-content-between card-btn collapsed bg-white px-0" href="javascript:;" role="button" data-toggle="collapse" data-target="#basicsCollapseFive" aria-expanded="false" aria-controls="basicsCollapseFive">
                            How good is your support service? Do you have a dedicated support team?
            ...
            <span class="card-btn-toggle">
              ...
              <span class="card-btn-toggle-active">−</span>
                    ...
                    <div id="basicsCollapseFive" class="collapse" aria-labelledby="basicsHeadingFive" data-parent="#basicsAccordion">
                        <div class="card-body px-0">
                            <p>Yes. We have an expert team of cloud engineers who are available round-the-clock to support and assist you on any queries. We strive to offer the best support service to our clients.
                            </p>
